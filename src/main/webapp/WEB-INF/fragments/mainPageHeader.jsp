...
<nav class="navbar navbar-expand-lg bg-white px-4 py-2">
	<div
		...
		<a class="navbar-brand d-flex align-items-center"
			...
			alt="Logo" class="me-2" style="height: 32px;">
		</a>
				...
				<li class="nav-item dropdown"><a
					...
					<div
						...
						<div class="list-group list-group-flush">
							<a href="#"
								class="text-center text-notification fw-bold border-bottom border-silver py-3 text-main">Notifications</a>
							...
							<c:choose>
								<c:when test="${not empty notifications}">
									<c:forEach var="notification" items="${notifications}"
										...
										<c:if test="${status.index < 5}">
											<a href="/notification/read/${notification.notifId}"
												class="list-group-item list-group-item-action border-bottom">
												<div class="row align-items-center">
													<div class="col-auto">
														<img
															src="${pageContext.request.contextPath}/volt/assets/img/team/profile-picture-1.jpg"
											...
											<c:if test="${status.index == 4 || status.last}">
												<!-- 🔽 최대 5개 또는 마지막 알림 이후에만 보더 라인 추가 -->
								...
								<c:otherwise>
									<div class="text-center py-3 text-muted border-silver">알림이
										없습니다.</div>
								</c:otherwise>
							</c:choose>

							<a href="#"
								class="dropdown-item text-notification text-center fw-bold rounded-bottom py-3"
