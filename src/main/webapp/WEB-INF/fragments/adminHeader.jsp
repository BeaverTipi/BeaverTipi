...
<nav class="navbar navbar-expand-lg px-4 py-2"
	style="background-color: transparent; justify-content: end; box-shadow: none;">
	<div
		...
		<ul class="navbar-nav flex-row gap-4 align-items-center mb-0">
			...
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath}/member/product/add">매물등록</a></li>
			...
			<security:authorize access="isAuthenticated()">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/resident/chat"
					id="chatSidebarLink">채팅</a></li>

				<!-- 🔔 알림 -->
				<li class="nav-item dropdown"><a
					class="nav-link text-dark notification-bell ${unreadCount > 0 ? 'unread' : ''} dropdown-toggle"
					id="notificationDropdown" href="#" role="button"
					data-bs-toggle="dropdown" aria-expanded="false"> <span
						class="position-relative d-inline-block"> <svg
					...
					<div
						class="dropdown-menu dropdown-menu-lg dropdown-menu-end mt-2 py-0">
						<div class="list-group list-group-flush">
							...
							<c:choose>
								<c:when test="${not empty notifications}">
									<c:forEach var="noti" items="${notifications}">
										<a
											href="${pageContext.request.contextPath}/notification/read/${noti.notifId}"
											class="list-group-item list-group-item-action border-bottom ${!noti.notifReadYn ? 'fw-bold' : ''}">
											<div class="row align-items-center">
												<div class="col-auto">
													<img
														src="${pageContext.request.contextPath}/volt/assets/img/alert-icon.png"
														class="avatar-md rounded" alt="알림">
												</div>
												<div class="col ps-0 ms-2">
													<div
														class="d-flex justify-content-between align-items-center">
														<h4 class="h6 mb-0 text-small">${noti.notifTitle}</h4>
							...
							<a href="${pageContext.request.contextPath}/notification/all"
				...
				<li class="nav-item dropdown"><a
					...
					aria-expanded="false"> <span class="text-dark">${principal.realUser.mbrNm}</span>
						<img class="avatar rounded-circle" alt="Profile"
						src="${pageContext.request.contextPath}/volt/assets/img/team/profile-picture-3.jpg"
						height="32" width="32">
				</a>
					<ul class="dropdown-menu dropdown-menu-end mt-2"
						...
						<li><a class="dropdown-item text-danger" id="logout"
							href="${pageContext.request.contextPath}/account/logout">로그아웃</a></li>
					</ul></li>
			</security:authorize>
