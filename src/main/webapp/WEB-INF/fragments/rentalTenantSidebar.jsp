<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="${pageContext.request.contextPath}/">
        <img class="navbar-brand-dark" src="${pageContext.request.contextPath}/admin/assets/img/brand/light.png" alt="Volt logo" /> <img class="navbar-brand-light" src="${pageContext.request.contextPath}/admin/assets/img/brand/dark.png" alt="Volt logo" />
    </a>
  ...
  <path d="M2 10a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1z"/>
          ...
          <span class="sidebar-text">납부</span>
        </a>
      </li>
      <li class="nav-item">
		  <a href="${pageContext.request.contextPath}/resident/dataState/bill" class="nav-link">
		    <span class="sidebar-icon">
       ...
       <li class="nav-item">
        <a href="${pageContext.request.contextPath}/resident/chat" class="nav-link" id = "chatSidebarLink">
          <span class="sidebar-icon">
