...
<head>
  ...
  <style>
    ...
    .tab-buttons { display: flex; gap: 8px; margin-bottom: 1rem; padding: 30px 30px 0 30px;}
    ...
    .tab-content { display: none; padding: 0 30px;}
...
<body>
  <div class="tab-wrap">
    <h2 style="padding: 30px 30px 0 30px;">입주 관리 대시보드</h2>
    <input type="hidden" id="hiddenRentalPtyId">

    <div class="filter-bar" style="margin-bottom: 1rem; padding: 0 30px;">
