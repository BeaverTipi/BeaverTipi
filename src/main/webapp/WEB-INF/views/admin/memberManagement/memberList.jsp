...
<div class="container-wrapper">
    <main class="container">
        <div class="search-area">
            <form:form method="get" modelAttribute="search" id="searchForm" action="/admin/member/list" class="search-form">
                ...
                <div class="search-button-area">
                    <button type="reset" id="resetButton" class="btn-warning">초기화</button> 
        ...
        <div class="write-buttons">
            <button type="button" id="saveButton" class="btn-success">저장하기</button> 
        </div>
