...
<body>
	<div class="register-wrapper">
		<div class="signup-container">
			...
			<form:form class="signup-form" method="post" enctype="multipart/form-data" action="/account/update"
				...
				<div class="profile-wrapper">
					...
					<div class="profile-upload-box">
						<label for="mbrProfilImg" class="upload-title">프로필 이미지
							수정</label>
						<div class="custom-file-upload">
							<label for="mbrProfilImg" class="file-label">파일 선택</label> <span
								id="file-name" class="file-name">선택된 파일 없음</span>
							<form:input type="file" path="mbrProfilImg" id="mbrProfilImg"
				...
				<div class="form-group-wrapper">
					<div class="form-group">
						...
						<form:errors path="mbrNm" cssClass="text-danger" />
					</div>
					...
					<div class="form-group">
						...
						<form:errors path="mbrNnm" cssClass="text-danger" />
					</div>
					...
					<div class="form-group">
						...
						<form:errors path="mbrEmlAddr" cssClass="text-danger" />
					</div>
					...
					<div class="phone-auth-wrapper">
						<div class="form-group">
							...
							<div class="phone-auth-group">
								<form:input path="mbrTelno" id="mbrTelno"
									class="form-control half" />
								<button type="button" id="requestAuthBtn" class="btn-auth-code">인증요청</button>
							<form:errors path="mbrTelno" cssClass="text-danger" />
							</div>
						</div>
						<div class="form-group">
							<div id="authCodeWrapper" class="hidden">
								<label for="authCode">인증번호</label> <input type="text"
									id="authCode" class="form-control" maxlength="6" />
							</div>
						</div>
					</div>
				</div>
