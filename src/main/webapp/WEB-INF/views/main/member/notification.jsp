  ...
  <c:choose>
    <c:when test="${not empty notifications}">
      <c:forEach var="noti" items="${notifications}">
        <div class="list-group-item border-bottom ${noti.notifReadYn eq 'N' ? 'fw-bold' : ''}">
            ...
            <div class="col ps-0 ms-2">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <h4 class="h6 mb-0 text-small notif-title-wrapper">
                  <a href="/notification/read/${noti.notifId}" class="text-decoration-none text-dark">
                    ${noti.notifTitle}
                  </a>
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <form method="post" action="/notification/delete/${noti.notifId}" id="searchForm" style="margin: 0;">
                  	<security:csrfInput/>
                    <input type="hidden" name="notifId" value="${noti.notifId}" />
                    <button type="submit" class="btn btn-delete-icon" id="deleteBtn" title="삭제">🗑</button>
                  </form>
                </div>
              </div>
